...
namespace UMatrizDispersaSM
{
        ...
        TForm* Form, int posX, int posY)
    {
        ...
        int offSetY = 63;
        dibujar_celda(
            Form, Form->Color, false, posX, posY, "nt = " + String(nt));
        posY += offSetY;
        dibujar_celda(
            Form, Form->Color, false, posX, posY, "df = " + String(df));
        posY += offSetY;
        dibujar_celda(
            Form, Form->Color, false, posX, posY, "df = " + String(df));
        posY += offSetY;
        dibujar_celda(
            Form, Form->Color, false, posX, posY, "dc = " + String(df));
        posY += offSetY;
        dibujar_celda(Form, Form->Color, false, posX, posY,
            "repe = " + String(df) + "\n");
    }
