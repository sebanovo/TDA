...
namespace UPolinomioPuntero
{
    ...
    void PolinomioPuntero::graficar_interseccion(TImage* Image,
        PolinomioPuntero* p1, PolinomioPuntero* p2, double a, double b)
    {
        TCanvas* Canvas = Image->Canvas;
        Canvas->FillRect(Canvas->ClipRect);
    ...
    std::string PolinomioPuntero::intersectar(
